...
#COMMAND="${NODEJS_BINARIES_PATH}/bin/npm start ${NODECELLAR_SOURCE_PATH}/${STARTUP_SCRIPT}"

ctx logger info "node js todo api start command: ${COMMAND}"
...
nohup ${COMMAND} > /home/centos/todo.log 2>&1 &
#nohup ${COMMAND} 2>&1 &
PID=$!
